...
public:
	...
	NormalYakuzaTypeSet() : IYakuzaTypeSet(en_campEnemy)
	{
		...
		m_animationDataList.push_back({ "Assets/modelData/Character/Joe/Animation/Grab_Throw_B.tka",true });//掴み投げられ
		m_animationDataList.push_back({ "Assets/modelData/Character/Joe/Animation/Grab_Break_B.tka",true });//掴み自己解除
		m_animationDataList.push_back({ "Assets/modelData/Character/Joe/Animation/Grab_Atk_B.tka",true });//掴みダメージ
